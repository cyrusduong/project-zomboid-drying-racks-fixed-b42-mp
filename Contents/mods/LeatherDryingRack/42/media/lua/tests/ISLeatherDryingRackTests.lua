	...
	for _, testCase in ipairs(testCases) do
		local mockPlayer = {
			getCurrentSquare = function()
				return {
					getX = function()
						return testCase.playerX
					end,
					getY = function()
						return testCase.playerY
					end,
				}
			end,
		}
		...
		local mockRack = {
			getSquare = function()
				return {
					getX = function()
						return testCase.rackX
					end,
					getY = function()
						return testCase.rackY
					end,
				}
			end,
		}
	...
	mockPlayer.inventory.items = {
		{
			...
			getDisplayName = function()
				return "Rabbit Hide (Furred, Wet)"
			end,
		},
		{
			type = "Base.PigLeather_Landrace_Fur_Tan_Wet",
			getDisplayName = function()
				return "Pig Hide (Furred, Wet)"
			end,
		},
		{
			type = "Base.DriedLeather_NotWet",
			getDisplayName = function()
				return "Dried Leather"
			end,
